...
export function AppShellClient({ profile, title, children }: { profile: ExtProfile; title: string; children: React.ReactNode }) {
  ...
  const avatar = photoUrl(profile.photo_url);
  ...
  async function markNotifications(id?: string) {
