...
export type RequestSummary = {
  ...
  teknisi_phone_number?: string | null;
  teknisi_company_name?: string | null;
  basecamp: string | null;
  ...
  koordinator_phone_number?: string | null;
  koordinator_company_name?: string | null;
