...
const config: Record<Mode, WorkflowConfig> = {
  LEADER: { title: "Approval Request Leader", desc: "Leader melakukan review awal request teknisi sebelum diproses Admin Gudang.", actionStatus: "PENDING", approveLabel: "Approve", approvePath: "leader-approve", notePlaceholder: "Catatan leader", success: "Request berhasil disetujui Leader." },
  KOORDINATOR: { title: "Tanda Tangan Surat Jalan", desc: "Koordinator menandatangani surat jalan yang sudah diproses Admin Gudang.", actionStatus: "WAITING_SIGNATURE", approveLabel: "Approve", approvePath: "koordinator-sign", notePlaceholder: "Catatan opsional", success: "Surat jalan berhasil ditandatangani Koordinator." },
  SUPERVISOR: { title: "Approval Final Surat Jalan", desc: "Supervisor melakukan approval final. Setelah final, material menunggu tanda tangan penerimaan teknisi.", actionStatus: "KOORDINATOR_SIGNED", approveLabel: "Approve", approvePath: "supervisor-approve", notePlaceholder: "Catatan opsional", success: "Surat jalan berhasil di-approve final." },
};
