...
const config: Record<Mode, WorkflowConfig> = {
  LEADER: { title: "Approval Request Leader", desc: "Leader melakukan review awal request teknisi sebelum diproses Admin Gudang.", actionStatus: "PENDING", approveLabel: "Approve", rejectLabel: "Reject", approvePath: "leader-approve", rejectPath: "leader-reject", notePlaceholder: "Catatan leader", success: "Request berhasil disetujui Leader." },
