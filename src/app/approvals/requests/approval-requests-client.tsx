...
type RequestDetailWithSerials = RequestDetail & { movements?: SerialMove[]; items: Array<RequestDetail["items"][number] & { serials?: SerialMove[] }> };
